...
internal fun MessageRoomEventResponse.toEventModel(
    userId: Int
): MessageRoomEvent =
    when (this) {
...
internal fun MessageRoomEventResponse.MessageParent.Message.toModel(
    userId: Int
): MessageRoomEvent.MessageParent =
    when (type) {
        "MESSAGE" -> {
...
// event mapper
internal fun MessageRoomEventResponse.DeleteMessage.toModel() =
    MessageRoomEvent.DeleteMessage(
        type = type.toMessageType(),
        userId = userId,
        messageId = messageId
    )

internal fun MessageRoomEventResponse.AddEmoji.toModel() =
    MessageRoomEvent.AddEmoji(
        type = type.toMessageType(),
        userId = userId,
        messageId = messageId,
        emojiId = emojiId
...
internal fun MessageRoomEventResponse.RemoveEmoji.toModel() =
    MessageRoomEvent.RemoveEmoji(
        type = type.toMessageType(),
        userId = userId,
        messageId = messageId,
        emojiId = emojiId
...
internal fun MessageRoomEventResponse.Sub.toModel() =
    MessageRoomEvent.Sub(
        type = type.toMessageType(),
        userId = userId
    )

internal fun MessageRoomEventResponse.TransperAdmin.toModel() =
    MessageRoomEvent.TransperAdmin(
        type = type.toMessageType(),
        userId = userId,
        roomId = roomId,
