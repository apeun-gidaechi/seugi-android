...
//                aiMessage.add(0, ChatData.AI("오늘 급식은 다음과 같습니다.", LocalDateTime.now().minusHours(9), true, false))
//                aiMessage.add(
//                    0,
//                    ChatData.AI(
//                        "아침\n---------\n쇠고기야채죽\n연유프렌치토스트\n배추김치\n포도\n허쉬초코크런치시리얼+우유\n\n" +
...
//                aiMessage.add(0, ChatData.AI("7월의 행사는 다음과 같습니다.", LocalDateTime.now().minusHours(9), true, false))
//                aiMessage.add(
//                    0,
//                    ChatData.AI(
//                        "7/12 나르샤프로젝트발표,SW축제\n7/16 독서토론대회\n7/17 해커톤",
...
//                aiMessage.add(0, ChatData.AI("8월의 행사는 다음과 같습니다.", LocalDateTime.now().minusHours(9), true, false))
//                aiMessage.add(
//                    0,
//                    ChatData.AI(
//                        "8/12 개학식, 타운홀미팅\n8/22 SW연합 토크콘서트\n8/30 수업나눔의 날",
...
//                aiMessage.add(0, ChatData.AI("오늘의 날씨는 다음과 같습니다.", LocalDateTime.now().minusHours(9), true, false))
//                aiMessage.add(
//                    0,
//                    ChatData.AI(
//                        "최고 기온 : 32°C\n최저 기온 : 21°C\n강수확률 : 20%\n습도 : 64%",
...
//            }
//            else -> {
//                aiMessage.add(0, ChatData.AI("오늘의 명언입니다.", LocalDateTime.now().minusHours(9), true, false))
//                aiMessage.add(
//                    0,
//                    ChatData.AI(
