...
fun NavGraphBuilder.chatScreen(userId: Long, workspaceId: String, navigateToChatDetail: (chatID: String) -> Unit, navigateToCreateRoom: (workspaceId: String, userId: Long) -> Unit) {
