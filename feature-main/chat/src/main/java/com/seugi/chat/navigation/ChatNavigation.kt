...
fun NavGraphBuilder.chatScreen(userId: Int, workspaceId: String, navigateToChatDetail: (chatID: String) -> Unit, navigateToCreateRoom: (workspaceId: String, userId: Int) -> Unit) {
