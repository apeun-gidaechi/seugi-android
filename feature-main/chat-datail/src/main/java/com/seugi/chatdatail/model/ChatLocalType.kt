...
sealed class ChatLocalType(
    ...
    data class FailedText(val text: String, val mention: List<Long>, override val uuid: String) : ChatLocalType(uuid)
    data class SendText(val text: String, val mention: List<Long>, override val uuid: String) : ChatLocalType(uuid)
