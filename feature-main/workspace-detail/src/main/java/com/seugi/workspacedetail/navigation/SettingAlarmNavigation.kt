...
fun NavController.navigateToWorkspaceSettingAlarm(navOptions: NavOptions? = null) = navigate(WORKSPACE_SETTING_ALARM_ROUTE, navOptions)

fun NavGraphBuilder.workspaceSettingAlarmScreen(workspaceId: String, popBackStack: () -> Unit) {
